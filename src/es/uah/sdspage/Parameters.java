...
public class Parameters extends Panel
{
    ...
    public Parameters set() {
        ...
        unknown1 = new Protein("Problema \u21161", "Aconitasa", "Acon", 0x14250, Color.black);
        unknown2 = new Protein("Problema \u21162", "Concanavalina A", "Con A", 25556, Color.black);
        unknown3 = new Protein("Problema \u21163", "Glucosa-oxidasa", "GO", 63058, Color.black);
        unknown4 = new Protein("Problema \u21164", "Neuraminidasa", "Neur", 43505, Color.black);
        unknown5 = new Protein("Problema \u21165", "Fosforilasa b", "Fos b", 0x172f9, Color.black);
        unknown6 = new Protein("Problema \u21166", "Piruvato-cinasa", "PK", 56773, Color.black);
        unknown7 = new Protein("Problema \u21167", "Ribonucleasa A", "RNasa A", 13673, Color.black);
        unknown8 = new Protein("Problema \u21168", "Quimotripsin�geno", "Quimo", 23564, Color.black);
        unknown9 = new Protein("Problema \u21169", "p-Hidroxibenzoato", "HOBz", 43939, Color.black);
        unknown10 = new Protein("Problema \u211610", "Ribonucleasa H", "RNasa H", 16638, Color.black);
        ...
        stdArray[std1Ref] = new Protein("Patrón \u21161", "beta-Galactosidasa", "\u03b2-gal.", 0x1c58b, Color.blue);
        stdArray[std2Ref] = new Protein("Patrón \u21162", "Ovalb\u00famina", "ovalb.", 42734, Color.yellow);
        stdArray[std3Ref] = new Protein("Patrón \u211623", "Anhidrasa carb\u00f3nica", "anh. carb.", 29011, Color.gray);
        stdArray[std4Ref] = new Protein("Patrón \u211624", "Triosa-fosfato-isomerasa", "TIM", 26527, Color.green);
        stdArray[std5Ref] = new Protein("Patrón \u211625", "Mioglobina", "Mioglob.", 17183, Color.magenta);
        stdArray[std6Ref] = new Protein("Patrón \u211626", "Lisozima", "Lisoz.", 14296, Color.white);
        stdArray[std7Ref] = new Protein("Patrón \u211627", "Inhibidor de tripsina", "BPTI", 6500, Color.red);
